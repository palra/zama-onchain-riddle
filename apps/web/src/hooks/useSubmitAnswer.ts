import { addSubmissionAtom, removeSubmissionAtom, setSubmissionTxHashAtom } from "@/lib/atoms/submissions";
...
export function useSubmitAnswer() {
  const addSubmission = useSetAtom(addSubmissionAtom);
  const setSubmissionTxHash = useSetAtom(setSubmissionTxHashAtom);
  const removeSubmission = useSetAtom(removeSubmissionAtom);
